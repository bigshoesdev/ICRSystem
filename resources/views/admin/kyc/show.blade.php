        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">@lang('general/message.show_user_verify') -
                        <small class="category">
                            @lang('general/message.with_user_verify')
                        </small>
                    </h4>
                    <form>
                        {{ csrf_field() }}
                        ...
                        <a href="{{route('admin.kyc.reject',['id'=>$verify->id])}}"
                           class="btn btn-danger">@lang('general/message.reject_request')</a>
                        <a href="{{route('admin.kyc.accept',['id'=>$verify->id])}}"
                           class="btn btn-success pull-right">@lang('general/message.accept_request')</a>
                ...
                <div class="card card-content">
                    <div class="card-content">
                        <div class="alert alert-primary">
                            <h4 class="card-title text-center"><span>@lang('general/message.identity_data')</span></h4>
                        </div>
                        <br>
                        <div class="col-md-12">
                            <div class="form-group label-floating">
                        ...
                        <div class="col-md-12">
                            <div class="form-group label-floating">
                                <label class="control-label" for="country">@lang('general/message.doc_no')</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group label-floating">
                                <label class="control-label" for="country">@lang('general/message.date_birth')</label>
                                <input type="text" value="{{$verify->dob}}" disabled class="form-control">
                            </div>
                        </div>
                        <br>
                        <h5 class="text-center text-info"> @lang('general/message.front_page_photo')</h5>
                        <br>
                        <div class="row">
                        ...
                        <br>
                        <h5 class="text-center text-info"> @lang('general/message.back_page_photo')</h5>
                        <br>
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="fileinput fileinput-new text-center">
