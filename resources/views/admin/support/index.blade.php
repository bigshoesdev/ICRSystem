...
@section('title')
    @lang('general/message.all_user_close_sup')
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">@lang('general/message.all_user_close_sup')</h4>
                            ...
                            <table class="table">
                                ...
                                @foreach($supports as $support)
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td class="text-center">
                                            <a href="{{route('admin.support.view', $support->ticket)}}" type="button"
                                               class="btn btn-info">
                                                <i class="material-icons">search</i> @lang('general/message.view')
                                            </a>
                                        </td>
