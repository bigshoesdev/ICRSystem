...
class AccountActiveSuccess extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(trans('notification/message.account_active_success'))
            ->greeting(trans('notification/message.congratulation'). $user->name.'!')
            ->line(trans('notification/message.account_email_verified'))
            ->line(trans('notification/message.account_other_verify'))
