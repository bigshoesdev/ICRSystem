...
class KYCVerifySuccess extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(trans('notification/message.identity_verify_success'))
            ->greeting(trans('notification/message.congratulation'). $user->name.'!')
            ->line(trans('notification/message.identity_verify_approve'))
            ->line(trans('notification/message.if_not_submit'))
